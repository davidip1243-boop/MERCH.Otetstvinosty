# Photos for the team T-shirt

Put the real photos into these folders:

- `white/01.jpg` through `white/05.jpg` for the white T-shirt
...
Use JPEG files and keep the exact folder names and numbering. More colours can be added later in `main.js` by copying one variant entry.
